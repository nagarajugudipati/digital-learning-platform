...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <a href="{{ route('admin.teachers-analytics') }}"
           class="group flex items-center gap-4 bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover:shadow-md hover:border-emerald-200 transition">
            ...
            <div class="flex-1 min-w-0">
                <p class="font-semibold text-gray-800 group-hover:text-emerald-700 transition">View Teacher Analytics</p>
                <p class="text-xs text-gray-500 mt-0.5">{{ number_format($stats['total_teachers']) }} teachers · courses created & student reach</p>
            </div>
            <svg class="w-5 h-5 text-gray-300 group-hover:text-emerald-500 transition flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
        </a>

        <a href="{{ route('admin.students-analytics') }}"
           class="group flex items-center gap-4 bg-white rounded-xl p-5 shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition">
            ...
            <div class="flex-1 min-w-0">
                <p class="font-semibold text-gray-800 group-hover:text-blue-700 transition">View Student Analytics</p>
                <p class="text-xs text-gray-500 mt-0.5">{{ number_format($stats['total_students']) }} students · enrollments & assigned teachers</p>
            </div>
            <svg class="w-5 h-5 text-gray-300 group-hover:text-blue-500 transition flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
            </svg>
        </a>
    </div>
